export default {
  ...
  page_tabs: {
    ...
    host_tab_08: 'Vegetarian',
    host_tab_09: 'Muslim Restaurants',
    ...
    country_by_skill_note:
      'The 2025 WorldSkills Asia Competition features 44 skills, and competitors will compete simultaneously throughout the competition period. The actual detailed schedule for each skill will be flexibly adjusted by the International Chief Expert appointed by WorldSkills Asia according to the test project content and on-site conditions. Therefore, the official website only provides the overall start and end times for public reference.',
...
This competition is expected to attract more than 500 participants from 29 members and guest countries across Asia, including Experts, Competitors, and professionals. <br><br>
...
Skills competitions are one of the agency’s key initiatives, aimed at establishing the value of skills, encouraging young people to actively participate in vocational education and training, and raising societal awareness of technical and vocational education. The competitions not only provide a platform for young people to showcase their skills, but also promote technical exchange and cooperation across industries, further enhancing the international competitiveness of the nation's workforce. Through these efforts, the Workforce Development Agency (WDA) not only improves the quality of the domestic workforce but also provides stable technical talent support for the country's economic development.
    ...
    illustration_title: 'For illustration purposes only',
  },
  competition: {
    title: 'Competition',
    title_tag: 'About',
...
<p>Come and unlock your experience today!
  ...
  media: {
    ...
    occupation_intro_title: 'Skills Introduction Video',
